package com.example.recursosnativos.view.screen
...
import com.example.recursosnativos.view.components.ImagenInteligente
...
fun PerfilScreen(viewModel: PerfilViewModel){
    ...
    fun createImagenUri(context: Context): Uri{
            ...
            Button(onClick = {
                when (PackageManager.PERMISSION_GRANTED){
                    ContextCompat.checkSelfPermission(context, Manifest.permission.CAMERA) -> {
                        val uri = createImagenUri(context)
                        cameraUri = uri
                ...
                Text("Toma una foto con la camara")
            }
        }
    }
}